      ...
      <div class="container">
        <div class="book-a-table menu-item filter-buat">
            <div class="section-title">
                ...
                <form action="{{url('/bookings')}}" method="post" role="form" class=" form-khusus" data-aos="fade-up" data-aos-delay="100">
                    @csrf
                    <div class="row">
                        <div class="col-lg-4 col-md-6 form-group">
                            <input type="date" name="tanggal_booking" class="form-control @error('tanggal_booking')is-invalid
                            @enderror" id="tanggal_booking" placeholder="Tanggal Booking" value="{{old('tanggal_booking')}}">
                        ...
                        <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                            ...
                            @enderror" id="notelp" placeholder="Nomor Telepon" value="{{old('notelp')}}">
                            @error('notelp')
                                {{$message}}
                            @enderror
                        </div>
                        <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                            ...
                            @enderror" name="jumlah" id="jumlah" placeholder="Jumlah orang" value="{{old('jumlah')}}">
                            @error('jumlah')
                                {{$message}}
                            @enderror
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        @enderror" name="deskripsi" rows="5" placeholder="Deskripsi/Keterangan">{{old('deskripsi')}}</textarea>
                        @error('deskripsi')
                        {{$message}}
                        @enderror
                    </div>
